...
\thesistitle{Machine learning techniques for flow-based intrusion detection systems} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
